...
//  TioDBBuilderSchemaIndexes = TioIndexList;
  ...
  IioDBBuilderEngine = interface
    ...
    ///  It must be called before CreateOrAlterDB or BuildCreateOrUpdateDBScript methods.
    ///  Not required by BuildCreateDBScript, which builds a full create-from-scratch script without introspecting the DB.
    ...
    /// </summary>
    procedure BuildCreateOrUpdateDBScript(const AScript: IioDBBuilderScript);
    /// <summary>
    ...
    /// <param name="AScript">The script where sql instructions will be returned.</param>
    /// </summary>
    procedure BuildCreateDBScript(const AScript: IioDBBuilderScript);
    /// <summary>
    ...
    /// </summary>
    procedure CreateOrUpdateDB(const Force: Boolean = False; const AScript: IioDBBuilderScript = nil);
    /// <summary>
