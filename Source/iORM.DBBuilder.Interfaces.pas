...
//  TioDBBuilderSchemaIndexes = TioIndexList;
  ...
  IioDBBuilderEngine = interface
    ...
    ///  It must be called before CreateOrAlterDB, BuildCreateDBSqlScript or BuildCreateOrUpdateDBSqlScript methods.
    ...
    ///  state, for documentation/baseline purposes. The resulting script must NOT be executed
