...
uses
  ...
  iORM.SynchroStrategy.Interfaces, iORM.Where.Interfaces, iORM.Abstraction;
...
type
  ...
  TioBSPersistenceStdActionVcl<T: IioBindSource> = class(Vcl.ActnList.TCustomAction, IioBSSlaveAction)
  strict private
    FAction_CloseQueryAction: IioBSSlaveAction;
  ...
  TioBSPersistenceSaveRevertPoint = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  strict protected
    procedure _InternalExecuteStdAction; override;
    function _InternalUpdateStdAction: Boolean; override;
  published
  ...
  TioBSPersistenceClear = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  strict protected
    procedure _InternalExecuteStdAction; override;
    function _InternalUpdateStdAction: Boolean; override;
  published
  ...
  TioBSPersistencePersist = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  strict protected
    procedure _InternalExecuteStdAction; override;
    function _InternalUpdateStdAction: Boolean; override;
  published
  ...
  TioBSPersistenceRevert = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  strict protected
    procedure _InternalExecuteStdAction; override;
    function _InternalUpdateStdAction: Boolean; override;
  published
  ...
  TioBSPersistenceRevertOrDelete = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  private
  ...
  TioBSPersistenceReload = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  strict protected
    procedure _InternalExecuteStdAction; override;
    function _InternalUpdateStdAction: Boolean; override;
  public
  ...
  TioBSDelete = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  strict protected
    procedure _InternalExecuteStdAction; override;
    function _InternalUpdateStdAction: Boolean; override;
  public
  ...
  TioBSAppend = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  private
  ...
  TioBSInsert = class(TioBSPersistenceStdActionVcl<IioBindSource>)
  private
    FEntityTypeAlias: String;
    FEntityTypeName: String;
    FOnNewInstanceAsObject: TioStdActionNewInstanceAsObjectEvent;
  ...
  TioBS_ETM_RevertToObject = class(TioBSPersistenceStdActionVcl<IioMasterBindSource>)
  strict private
  ...
  TioBS_ETM_RevertToBindSource = class(TioBSPersistenceStdActionVcl<IioMasterBindSource>)
  strict private
    FAutoExec_OnETMfor_AfterRevert: TioStdAction_ETM_AutoExec_AfterRevert;
    FAutoExec_OnTargetBS_AfterRevert: TioStdAction_ETM_AutoExec_AfterRevert;
    FAutoExec_Persist_AfterRevert: Boolean;
  ...
  TioBSCloseQuery = class(TioBSPersistenceStdActionVcl<IioBindSource>, IioBSCloseQueryAction)
  strict private
...
constructor TioBSPersistenceStdActionVcl<T>.Create(AOwner: TComponent);
begin
  inherited;
...
function TioBSPersistenceStdActionVcl<T>.GetExecutionMode: TioActionExecutionMode;
begin
  Result := FExecutionMode;
end;

function TioBSPersistenceStdActionVcl<T>.Get_Version: String;
begin
  Result := io.Version;
end;
...
procedure TioBSPersistenceStdActionVcl<T>.SetAction_CloseQueryAction(const Value: IioBSSlaveAction);
begin
...
procedure TioBSPersistenceStdActionVcl<T>.SetAction_ShowOrSelectAction(const Value: IioBSSlaveAction);
begin
...
procedure TioBSPersistenceStdActionVcl<T>.SetExecutionMode(const Value: TioActionExecutionMode);
begin
  FExecutionMode := Value;
end;

procedure TioBSPersistenceStdActionVcl<T>.SetTargetBindSource(const Value: T);
begin
...
procedure TioBSPersistenceStdActionVcl<T>.UpdateTarget(Target: TObject);
var
  LEnabled: Boolean;
begin
  inherited;
...
procedure TioBSPersistenceStdActionVcl<T>._InternalExecuteStdAction;
begin
  // Nothing to do here
end;

function TioBSPersistenceStdActionVcl<T>._InternalUpdateStdAction: Boolean;
begin
  Result := True;
...
function TioBSPersistenceStdActionVcl<T>._IsEnabled: Boolean;
begin
  Result := Enabled;
end;

procedure TioBSPersistenceStdActionVcl<T>._SetTargetBindSource(const AObj: TObject);
var
  LTargetBindSource: IioBindSource;
begin
  if Assigned(AObj) and not Supports(AObj, IioBindSource, LTargetBindSource) then
    raise EioGenericException.Create(ClassName, '_SetTargetBindSource', 'AObj does not implements IioBindSource interface');
  FIsSlave := False;
...
constructor TioBSDelete.Create(AOwner: TComponent);
begin
  inherited;
  RaiseIfChangesExists := False;
end;

procedure TioBSDelete._InternalExecuteStdAction;
begin
...
constructor TioBSAppend.Create(AOwner: TComponent);
begin
  inherited;
  FEntityTypeAlias := '';
  FEntityTypeName := '';
...
procedure TioBSAppend._InternalExecuteStdAction;
var
...
constructor TioBSInsert.Create(AOwner: TComponent);
begin
  inherited;
  FEntityTypeAlias := '';
  FEntityTypeName := '';
...
procedure TioBSInsert._InternalExecuteStdAction;
var
  LNewInstanceAsObject: TObject;
  LNewInstanceAsInterface: IInterface;
begin
...
function TioBSStdActionVcl<T>.GetExecutionMode: TioActionExecutionMode;
begin
  Result := FExecutionMode;
end;
...
procedure TioBSStdActionVcl<T>.SetExecutionMode(const Value: TioActionExecutionMode);
begin
  FExecutionMode := Value;
end;
...
function TioBSStdActionVcl<T>._InternalUpdateStdAction: Boolean;
begin
  Result := True;
end;
  ...
  case FShowMode of
    ...
    smEntityTypeNameAsSelector:
      case FViewContextBy of
        ...
        vcByViewContextProviderName:
          io.ShowAsSelector(FEntityTypeName, FWhere, FTargetBindSource as IioBindSource, FAction_ParentCloseQueryAction, io.VCProviderByName(FViewContextProviderName),
            FVVMTypeAlias);
        vcByViewContextProvider:
    ...
    smEntityTypeNameAsWhereBuilder:
      case FViewContextBy of
        ...
        vcByViewContextProviderName:
          io.ShowAsWhereBuilder(FEntityTypeName, FWhere, FTargetBindSource as IioMasterBindSource, FAction_ParentCloseQueryAction,
    ...
    smEntityTypeNameAsETM:
      case FViewContextBy of
        ...
        vcByViewContextProviderName:
          io.ShowAsETM(FEntityTypeName, FWhere, FTargetBindSource as IioMasterBindSource, FAction_ParentCloseQueryAction, io.VCProviderByName(FViewContextProviderName),
            FVVMTypeAlias);
        vcByViewContextProvider:
...
begin
  Result := True;
  // If the TargetBindSource is a SelectorFor some other BindSource then make the selection instead
  if Assigned(FAction_SelectCurrentAction) and Assigned(FTargetBindSource.SelectorFor) then
  begin
...
begin
  ...
  Result := Result and Assigned(LMasterBindSource.Current);
