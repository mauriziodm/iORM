...
{$ENDIF}
  ...
  RegisterComponents('iORM - Synchronization strategies', [TioEtmBasedSynchroStrategy_Client]);
  RegisterSelectionEditor(TioEtmBasedSynchroStrategy_Client, TioSynchroStrategySelectionEditor);
