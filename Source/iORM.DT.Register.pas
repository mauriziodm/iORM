...
{$ENDIF}
  iORM.DB.DataSet.Detail, iORM.DB.MemTable, iORM.LiveBindings.PrototypeBindSource.Master,
...
{$ENDIF}
  ...
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSAppend], nil);
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSPersistenceClear], nil);
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSDelete], nil);
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSInsert], nil);
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSPersistencePersist], nil);
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSPersistenceReload], nil);
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSPersistenceRevert], nil);
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSPersistenceRevertOrDelete], nil);
  RegisterActions('iORM - BS', [iORM.StdActions.Fmx.TioBSPersistenceSaveRevertPoint], nil);
