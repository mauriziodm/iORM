...
{$ENDIF}
  ...
  RegisterActions('iORM - BS - WhereBuilder', [iORM.StdActions.Vcl.TioBSWhereClear], nil);
  ...
  RegisterActions('iORM - BS - WhereBuilder', [iORM.StdActions.Fmx.TioBSWhereClear], nil);
