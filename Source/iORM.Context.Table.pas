...
begin
  // TODO: Possibile togliere questo if? ho dovuto metterlo perch� altrimenti dava un AV error gi� quando installavo nell'IDE dovuto al fatto che ancora il session DataStore non era assegnato
