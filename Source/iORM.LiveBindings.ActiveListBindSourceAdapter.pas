...
function TioActiveListBindSourceAdapter.GetDetailAdaptersContainer: IioDetailBindSourceAdaptersContainer;
begin
...
function TioActiveListBindSourceAdapter.NewDetailBindSourceAdapter(const ABindSource: IioBindSource; const AMasterPropertyName: String): IioActiveBindSourceAdapter;
begin
...
function TioActiveListBindSourceAdapter.GetAutoPost: Boolean;
begin
...
function TioActiveListBindSourceAdapter.GetObjStatus: TioObjStatus;
begin
...
function TioActiveListBindSourceAdapter.NewNaturalObjectBindSourceAdapter(const ABindSource: IioBindSource): IioActiveBindSourceAdapter;
begin
...
function TioActiveListBindSourceAdapter.GetHasBindSource: Boolean;
begin
...
function TioActiveListBindSourceAdapter.GetIsInterfaceBSA: Boolean;
begin
  Result := False;
end;

function TioActiveListBindSourceAdapter.GetIsMasterBSA: Boolean;
begin
...
function TioActiveListBindSourceAdapter.GetMasterAdaptersContainer: IioDetailBindSourceAdaptersContainer;
begin
...
procedure TioActiveListBindSourceAdapter.SetBindSource(ABindSource: IioBindSource);
begin
  FBindSource := ABindSource;
end;
...
procedure TioActiveListBindSourceAdapter.SetDataObject(const ADataObject: TObject; const AOwnsDataObject: Boolean);
begin
  if Self.HasMasterBSA then
...
procedure TioActiveListBindSourceAdapter.SetDataObject(const ADataObject: IInterface; const AOwnsDataObject: Boolean);
begin
  if Self.HasMasterBSA then
...
procedure TioActiveListBindSourceAdapter.InternalSetDataObject(const ADataObject: IInterface; const AOwnsDataObject: Boolean);
begin
  Self._InternalSetDataObject<IInterface>(ADataObject as TObject, AOwnsDataObject);
end;

procedure TioActiveListBindSourceAdapter.InternalSetDataObject(const ADataObject: TObject; const AOwnsDataObject: Boolean);
begin
  Self._InternalSetDataObject<TObject>(ADataObject, AOwnsDataObject);
end;

procedure TioActiveListBindSourceAdapter.SetAutoPost(const Value: Boolean);
begin
...
function TioActiveListBindSourceAdapter.GetObjStatusInUse: Boolean;
begin
  Result := TioCommonBSABehavior.GetObjStatusInUse(Self);
end;

function TioActiveListBindSourceAdapter.GetOwnsDataObject: Boolean;
begin
...
procedure TioActiveListBindSourceAdapter._InternalSetDataObject<T>(const ADataObject: TObject; const AOwnsDataObject: Boolean);
var
