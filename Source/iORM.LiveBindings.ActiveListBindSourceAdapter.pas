...
procedure TioActiveListBindSourceAdapter.ListViewDeletingTimerEventHandler(Sender: TObject);
var
  LTimer: TioTimer;
...
procedure TioActiveListBindSourceAdapter.SetioWhereDetailsFromDetailAdapters(const Value: Boolean);
begin
