...
procedure TioActiveListBindSourceAdapter.DoBeforeScroll;
begin
  inherited;
...
procedure TioActiveListBindSourceAdapter.Notify(const Sender: TObject; const [Ref] ANotification: TioBSNotification);
begin
