...
type
  ...
  private
    ...
    // DesignTime (WhereStrssss property) non funzionassero per questo motivo.
...
procedure TioPrototypeBindSourceCustom.DoAfterReceiveSelection(var ASelected: IInterface; var ASelectionType: TioSelectionType);
begin
  if Assigned(FAfterReceiveSelectionInterface) then
    FAfterReceiveSelectionInterface(Self, ASelected, ASelectionType);
end;

procedure TioPrototypeBindSourceCustom.DoAfterReceiveSelection(var ASelected: TObject; var ASelectionType: TioSelectionType);
begin
...
procedure TioPrototypeBindSourceCustom.DoBeforeReceiveSelection(var ASelected: IInterface; var ASelectionType: TioSelectionType; const AAuthDecisionRequest: IioAuthDecisionRequest);
begin
...
procedure TioPrototypeBindSourceCustom.DoBeforeReceiveSelection(var ASelected: TObject; var ASelectionType: TioSelectionType; const AAuthDecisionRequest: IioAuthDecisionRequest);
begin
...
procedure TioPrototypeBindSourceCustom.DoReceiveSelection(var ASelected: TObject; var ASelectionType: TioSelectionType; var ADone: Boolean);
begin
  if Assigned(FonReceiveSelectionObject) then
    FonReceiveSelectionObject(Self, ASelected, ASelectionType, ADone);
end;

procedure TioPrototypeBindSourceCustom.DoReceiveSelection(var ASelected: IInterface; var ASelectionType: TioSelectionType; var ADone: Boolean);
begin
...
function TioPrototypeBindSourceCustom.GetAsyncLoad: Boolean;
begin
  Result := FAsyncLoad;
end;

function TioPrototypeBindSourceCustom.GetAsyncPersist: Boolean;
begin
...
function TioPrototypeBindSourceCustom.GetLazy: Boolean;
begin
  Result := FLazy;
end;

function TioPrototypeBindSourceCustom.GetLazyProps: String;
begin
  Result := FLazyProps;
end;
...
function TioPrototypeBindSourceCustom.GetTypeAlias: String;
begin
  Result := FTypeAlias;
end;
