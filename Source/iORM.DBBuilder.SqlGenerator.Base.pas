...
type
  ...
  protected
    ...
    procedure InitializeScript; virtual;
    procedure FinalizeScript; virtual;
...
procedure TioDBBuilderSqlGenBase.FinalizeScript;
begin
  ScriptAddEmpty;
  ScriptAddSeparator;
...
procedure TioDBBuilderSqlGenBase.InitializeScript;
begin
  ScriptAddSeparator;
