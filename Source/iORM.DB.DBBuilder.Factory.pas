...
type
  ...
  public
    class function NewSqlGenerator(AOnlyCreateScript: Boolean): IioDBBuilderSqlGenerator;
...
class function TioDBBuilderFactory.NewSqlGenerator(AOnlyCreateScript: Boolean): IioDBBuilderSqlGenerator;
begin
