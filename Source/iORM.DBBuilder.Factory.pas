...
type
  ...
  public
    ...
    class function NewSqlScriptSection: IioDBBuilderSqlScriptSection;
...
class function TioDBBuilderFactory.NewSqlScriptSection: IioDBBuilderSqlScriptSection;
begin
  Result := TioDBBuilderScriptSection.Create;
end;
