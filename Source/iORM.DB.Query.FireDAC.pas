...
begin
  ...
  begin
    ...
    LFarAncestorClassName := io.di.Resolve(AContext.OriginalNonTrueClassMap.GetClassName).GetImplementersItem.FarAncestorClazzSameInterfaceAndTableAndConnection;
