...
type
  ...
  public
    ...
    // Auth
    class function _DoAuthorizeUser(const AConnectionDefName: String; const AUserCredentials: IioAuthCredentials; out ResultUserAuthorizationToken: String): Boolean; override;
    class function _DoAuthorizeApp(const AConnectionDefName: String; const AAppCredentials: IioAuthCredentials; AUserAuthorizationToken: String; out ResultAppAuthorizationToken: String): Boolean; override;
...
class function TioPersistenceStrategyHttp._DoAuthorizeApp(const AConnectionDefName: String; const AAppCredentials: IioAuthCredentials; AUserAuthorizationToken: String; out ResultAppAuthorizationToken: String): Boolean;
var
  LConnection: IioConnectionHttp;
begin
  inherited;
...
class function TioPersistenceStrategyHttp._DoAuthorizeUser(const AConnectionDefName: String; const AUserCredentials: IioAuthCredentials; out ResultUserAuthorizationToken: String): Boolean;
var
  LConnection: IioConnectionHttp;
begin
  inherited;
