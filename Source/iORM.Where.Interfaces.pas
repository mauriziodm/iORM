...
type
  ...
  IioWhere = interface
    ...
    procedure CreateIndex(const AIndexName:String; ACommaSepFieldList:String; const AIndexOrientation:TioOrientation=ioAscending; const AUnique:Boolean=False); overload;
