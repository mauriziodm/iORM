...
//    property ClearAfterExecute; // Eliminata perchè poteva interferire con TioVMActionBSCloseQuery
  ...
  TioVMActionBS_ETM_Revert = class(TioVMActionBSPersistenceCustom)
  strict private
...
begin
  ...
  if Assigned(FAction_CloseQueryAction) and FAction_CloseQueryAction._IsEnabled and FAction_CloseQueryAction._IsEnabled then
...
constructor TioVMActionBS_ETM_Revert.Create(AOwner: TComponent);
begin
  inherited;
  FPersistImmediately := False;
end;

procedure TioVMActionBS_ETM_Revert._InternalExecuteStdAction;
begin
  inherited;
...
procedure TioVMActionBS_ETM_Revert._InternalUpdateStdAction;
begin
  inherited;
