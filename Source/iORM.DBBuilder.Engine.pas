...
type
  ...
  public
    constructor Create(const AConnectionDefName: String; const ABuildIndexes, ABuildForeignKeys: Boolean);
...
constructor TioDBBuilderEngine_New.Create(const AConnectionDefName: String; const ABuildIndexes, ABuildForeignKeys: Boolean);
begin
