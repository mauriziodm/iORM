  ...
  try
    ...
    begin
      ...
      if LRttiType.IsInstance and IsAnEntity(LRttiType.AsInstance) then
        ...
        // NB: Mauri 30/07/2022: Nel metodo "DIC_AutoregisterClassesByAttributes" registro automaticamente come entità anche la classe più possibile in alto nella gararchia
