...
procedure TDuckTypedList.AddValue(const AValue: TValue);
begin
  FAddMethod.Invoke(FObjectAsDuck, [AValue]);
end;
...
function TDuckTypedList.GetItemValue(const index: Integer): TValue;
begin
  Result := FGetItemMethod.Invoke(FObjectAsDuck, [index]);
end;
