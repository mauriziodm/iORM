...
uses
  System.Generics.Collections, DJSON.Attributes, Interfaces, Serializers;
...
type
  ...
  private
    FID: Integer;
    FName: string;
    [djItemsType(TypeInfo(String), TypeInfo(TPhoneNumber))]  // Not needed if "TypeAnnnotations" = True or "ItemsType" is specified
