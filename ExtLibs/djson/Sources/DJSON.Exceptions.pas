...
type
  ...
  // Generic DJSON exception
  EdjException = class(Exception)
  end;

  // Engine exception
  EdjEngineError = class(EdjException)
  end;

  // DuckTyping exception
  EdsonDuckException = class(EdjException)
  end;
