...
begin
  ...
  // TOrder
  if (AAuthDecisionRequest.TypeName = 'TOrder') or (AAuthDecisionRequest.TypeName = 'IOrder') then
  ...
  if ((AAuthDecisionRequest.TypeName = 'TCustomer') or (AAuthDecisionRequest.TypeName = 'ICustomer')) and (AAuthDecisionRequest.AuthorizationContext = 'order') then
    case AAuthDecisionRequest.ActionType of
  ...
  // TCustomer
  if (AAuthDecisionRequest.TypeName = 'TCustomer') or (AAuthDecisionRequest.TypeName = 'ICustomer') then
    case AAuthDecisionRequest.ActionType of
  ...
  // TPizza
  if (AAuthDecisionRequest.TypeName = 'TPizza') or (AAuthDecisionRequest.TypeName = 'IPizza') then
    case AAuthDecisionRequest.ActionType of
  ...
  // TIngredient
  if (AAuthDecisionRequest.TypeName = 'TIngredient') or (AAuthDecisionRequest.TypeName = 'IIngredient') then
    case AAuthDecisionRequest.ActionType of
